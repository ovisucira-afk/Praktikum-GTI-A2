...
void Display(void){ 
	...
	glLoadIdentity(); // mengembalikan matriks ke awal (tidak tertimpa)
	glBegin(GL_POLYGON);
...
void Reshape(int x, int y){  // mengatur ukuran segitiga
	...
	gluPerspective(40.0,(GLdouble)x/(GLdouble)y,0.5,20.0); // sudut pandang
...
int main (int argc, char** argv){
	...
	glutInitWindowSize(300,300); glutCreateWindow("Ovilia Suci Ramadhani");
